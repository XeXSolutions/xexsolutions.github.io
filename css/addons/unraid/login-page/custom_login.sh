...
TYPE="retro-terminal"
THEME="white.css"
DOMAIN="github.com/XeXSolutions" # If you update the domain after the script has been run, You must disable and re the whole theme with the DISABLE_THEME env.
SCHEME="https"
ADD_JS="true"
